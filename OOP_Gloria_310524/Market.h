...
public:
  ...
  inline double getbondprices(const string& name)const { return bondPrices.at(name); };
  inline double getstockprices(const string& name)const { return stockPrices.at(name); };
private:
